package com.dj.boot.canal.connector;
 ...
 */
@Slf4j
public class RocketCanalConnector implements CanalMQConnector {
    ...
    public RocketCanalConnector(String nameServer, String topic, String groupName, String accessKey,
    ...
    public RocketCanalConnector(String nameServer, String topic, String groupName, Integer batchSize,
                                boolean flatMessage){
    ...
    public synchronized void subscribe(String filter) throws CanalClientException {
        ...
        try {
            ...
            connected = false;
            log.error("Start RocketMQ consumer error", ex);
        }
        connected = true;
    }
    ...
    private boolean process(List<MessageExt> messageExts) {
        if (log.isDebugEnabled()) {
            log.debug("Get Message: {}", messageExts);
        }
        ...
        for (MessageExt messageExt : messageExts) {
            ...
            if (data != null) {
                try {
                    ...
                    log.error("Add message error", ex);
                    throw new CanalClientException(ex);
                }
            } else {
                log.warn("Received message data is null");
            }
        }
